...
"""
        ...
        assert len(found_types & expected_types) >= 5, f"Expected more element types, found: {found_types}"
...
"""
    ...
    def _collect_inline_elements(self, ast: Dict[str, Any], elements: List[Dict] = None) -> List[Dict]:
