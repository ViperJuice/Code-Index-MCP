...
DEFAULT_ACCESS_RULES = [
    ...
    AccessRule(
        path_pattern="/api/v1/security/events",
        access_level=AccessLevel.RESTRICTED,
        required_role=UserRole.ADMIN,
        required_permissions=[Permission.ADMIN],
        allowed_operations=[Permission.READ],
    ...
    AccessRule(
        ...
        required_role=UserRole.ADMIN,
        required_permissions=[Permission.ADMIN],
        allowed_operations=[Permission.WRITE],
    ),
    AccessRule(
        path_pattern="/reindex",
        access_level=AccessLevel.PROTECTED,
        required_permissions=[Permission.EXECUTE],
        allowed_operations=[Permission.WRITE],
    ),
    AccessRule(
        path_pattern="/cache/stats",
        access_level=AccessLevel.PROTECTED,
        required_permissions=[Permission.READ],
        allowed_operations=[Permission.READ],
    ),
    ...
    AccessRule(
        path_pattern="/search/config/weights",
        access_level=AccessLevel.RESTRICTED,
        required_role=UserRole.ADMIN,
        required_permissions=[Permission.ADMIN],
        allowed_operations=[Permission.WRITE],
    ...
    AccessRule(
        path_pattern="/search/config/methods",
        access_level=AccessLevel.RESTRICTED,
        required_role=UserRole.ADMIN,
        required_permissions=[Permission.ADMIN],
        allowed_operations=[Permission.WRITE],
