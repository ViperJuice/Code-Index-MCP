...
from .auth_manager import AuthManager, AuthenticationError, AuthorizationError, SecurityError
from .models import (
    TokenData, AccessRequest, Permission, SecurityConfig, SecurityEvent,
    User, UserRole
)
...
class AuthenticationMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: FastAPI, auth_manager: AuthManager, excluded_paths: Optional[List[str]] = None):
        super().__init__(app)
        self.auth_manager = auth_manager
