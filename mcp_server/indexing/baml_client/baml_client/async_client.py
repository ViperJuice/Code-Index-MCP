...
class BamlAsyncClient:
    ...
    async def SummarizeChunkAlone(
        ...
        if "on_tick" in baml_options:
            ...
            __stream__ = self.stream.SummarizeChunkAlone(
                language=language,
                symbol=symbol,
            ...
            __result__ = await self.__options.merge_options(baml_options).call_function_async(
                function_name="SummarizeChunkAlone",
                args={
                    "language": language,
                    "symbol": symbol,
                    "line_start": line_start,
    ...
    async def SummarizeFileChunks(
        self,
        language: str,
        file_path: str,
        file_content: str,
        chunks: typing.List["types.ChunkInput"],
        baml_options: BamlCallOptions = {},
    ) -> types.FileSummaryResult:
        # Check if on_tick is provided
        if "on_tick" in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.SummarizeFileChunks(
                language=language,
                file_path=file_path,
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(
                function_name="SummarizeFileChunks",
                args={
                    "language": language,
                    "file_path": file_path,
                    "file_content": file_content,
...
class BamlStreamClient:
    ...
    def SummarizeChunkAlone(
        ...
        file_context: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ChunkSummary, types.ChunkSummary]:
        ...
        return baml_py.BamlStream[stream_types.ChunkSummary, types.ChunkSummary](
            __result__,
            lambda x: typing.cast(
                stream_types.ChunkSummary, x.cast_to(types, types, stream_types, True, __runtime__)
            ),
            lambda x: typing.cast(
                types.ChunkSummary, x.cast_to(types, types, stream_types, False, __runtime__)
            ),
            __ctx__,
        )

    def SummarizeFileChunks(
        self,
        language: str,
        file_path: str,
        file_content: str,
        chunks: typing.List["types.ChunkInput"],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.FileSummaryResult, types.FileSummaryResult]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(
            function_name="SummarizeFileChunks",
            args={
                "language": language,
        ...
        return baml_py.BamlStream[stream_types.FileSummaryResult, types.FileSummaryResult](
            __result__,
            lambda x: typing.cast(
                stream_types.FileSummaryResult,
                x.cast_to(types, types, stream_types, True, __runtime__),
            ),
            lambda x: typing.cast(
                types.FileSummaryResult, x.cast_to(types, types, stream_types, False, __runtime__)
            ),
            __ctx__,
        )
