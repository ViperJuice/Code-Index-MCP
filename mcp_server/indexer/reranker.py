...
class IReranker(ABC):
    @abstractmethod
    async def rerank(self, query: str, results: List[SearchResult], top_k: int = 10) -> RerankResult:
        pass
...
class HybridReranker(BaseReranker):
    ...
    def set_rerankers(
        self, 
        primary: IReranker, 
        fallback: Optional[IReranker] = None
    ):
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        ...
        capabilities = {
            ...
            'primary': self.primary_reranker.get_capabilities() if self.primary_reranker else None,
            'fallback': self.fallback_reranker.get_capabilities() if self.fallback_reranker else None,
