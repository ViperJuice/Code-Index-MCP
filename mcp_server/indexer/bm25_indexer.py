...
class BM25Indexer(IIndexer):
    ...
    def _index_symbols(self, conn: sqlite3.Connection, file_id: int, filepath: str, 
    ...
    def _search_content(self, conn: sqlite3.Connection, query: str, limit: int,
    ...
    def _search_symbols(self, conn: sqlite3.Connection, query: str, limit: int,
    ...
    def _search_documents(self, conn: sqlite3.Connection, query: str, limit: int,
                         **kwargs) -> List[Dict[str, Any]]:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        with self.storage._get_connection() as conn:
            ...
            return {
                ...
                'features': ['phrase_search', 'prefix_search', 'boolean_operators', 'ranking']
            }
    ...
    def search_near(self, terms: List[str], distance: int = 10, limit: int = 20) -> List[Dict[str, Any]]:
        """
