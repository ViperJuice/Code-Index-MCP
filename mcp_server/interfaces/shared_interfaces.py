...
from typing import Any, Dict, List, Optional, Callable, ContextManager, Awaitable, TypeVar, Generic
...
class ILogger(ABC):
    ...
    @abstractmethod
    def error(self, message: str, exception: Exception = None, context: Dict[str, Any] = None) -> None:
...
class ConfigurationError(Exception):
    ...
    def __init__(self, config_key: str, expected_type: str, actual_value: Any):
        ...
        super().__init__(f"Config key '{config_key}' expected {expected_type}, got {type(actual_value).__name__}")
