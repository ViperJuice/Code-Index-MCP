...
class ICacheManager(ABC, ICache):
    ...
    @abstractmethod
    async def set_with_options(self, key: str, value: Any, ttl: Optional[int] = None, 
...
class IQueryCache(ABC):
    ...
    @abstractmethod
    async def cache_query_result(self, query: str, params: Dict[str, Any], result: Any, ttl: Optional[int] = None) -> None:
        """Cache query result"""
        pass
...
class ISessionCache(ABC):
    ...
    @abstractmethod
    async def store_session(self, session_id: str, data: Dict[str, Any], ttl: Optional[int] = None) -> None:
        """Store session data"""
        pass
...
class IImageCache(ABC):
    ...
    @abstractmethod
    async def cache_file(self, file_path: str, content: bytes, content_type: str, ttl: Optional[int] = None) -> None:
        """Cache file content"""
        pass
