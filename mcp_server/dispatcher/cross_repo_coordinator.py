...
class CrossRepositoryCoordinator:
    ...
    def _init_strategies(self) -> Dict[str, SearchStrategy]:
        ...
        return {
            'symbol': SearchStrategy(
                name='symbol',
                scorer=self._score_symbol_result,
                filter=self._filter_symbol_result
            ),
            'code': SearchStrategy(
                name='code',
                scorer=self._score_code_result,
                filter=self._filter_code_result
            ),
    ...
    def _apply_filter(self, 
                     ...
                     context: SearchContext) -> List[CrossRepoSearchResult]:
    ...
    def _aggregate_results(self,
                          results: List[CrossRepoSearchResult],
                          context: SearchContext) -> List[AggregatedResult]:
    ...
    def _convert_to_aggregated(self,
                              results: List[CrossRepoSearchResult]) -> List[AggregatedResult]:
