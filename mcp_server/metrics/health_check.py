...
class ComponentHealthChecker(IHealthCheck):
    ...
    def register_health_check(self, component_name: str, check_func: Callable[[], Awaitable[HealthCheckResult]]) -> None:
    ...
    def create_database_health_check(self, db_path: str) -> Callable[[], Awaitable[HealthCheckResult]]:
    ...
    def create_plugin_health_check(self, plugin_manager) -> Callable[[], Awaitable[HealthCheckResult]]:
        ...
        async def check_plugins() -> HealthCheckResult:
            try:
                ...
                failed_plugins = [name for name, status in plugin_status.items() 
