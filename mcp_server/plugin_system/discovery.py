...
class PluginDiscovery:
    ...
    def load_plugin(self, language: str, sqlite_store: SQLiteStore = None, 
                    enable_semantic: bool = True) -> Optional[IPlugin]:
        """
    ...
    def register_plugin(self, language: str, plugin_class: Type[IPlugin], 
                       name: str = None, version: str = "1.0.0"):
        """
