...
def validate_security_config(settings: Settings) -> List[str]:
    ...
    if is_production():
        ...
        if security.jwt_secret_key in ["your-secret-key", "secret", "admin123!", "changeme"]:
...
def validate_production_config(settings: Optional[Settings] = None) -> Dict[str, List[str]]:
    """
