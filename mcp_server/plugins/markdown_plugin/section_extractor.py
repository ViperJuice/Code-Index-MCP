...
class SectionExtractor:
    ...
    def find_section_by_heading(self, sections: List[Dict[str, Any]], heading: str) -> Optional[Dict[str, Any]]:
        """Find a section by its heading text."""
        heading_lower = heading.lower()
        
        def search_sections(section_list: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
            for section in section_list:
    ...
    def get_section_path(self, sections: List[Dict[str, Any]], target_id: str) -> List[str]:
        ...
        def find_path(section_list: List[Dict[str, Any]], current_path: List[str]) -> Optional[List[str]]:
            for section in section_list:
    ...
    def get_table_of_contents(self, sections: List[Dict[str, Any]], max_depth: int = 3) -> List[Dict[str, Any]]:
    ...
    def merge_sections(self, sections1: List[Dict[str, Any]], sections2: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
