...
class Plugin(PluginWithSemanticSearch):
    ...
    def _init_treesitter(self):
        ...
        try:
            ...
            go_config = {
                ...
                'name': 'Go',
                'extensions': ['.go'],
                'symbols': ['function_declaration', 'method_declaration', 
    ...
    def _enhance_symbols(self, path: Path, content: str, 
    ...
    def check_interface_implementation(self, type_name: str, 
                                     interface_name: str) -> Optional[Dict[str, Any]]:
