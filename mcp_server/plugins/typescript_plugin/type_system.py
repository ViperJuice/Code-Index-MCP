...
class TypeInferenceEngine:
    ...
    def __init__(self):
        ...
        self._builtin_types = {
            ...
            'void', 'never', 'unknown', 'any', 'bigint', 'symbol',
            'Array', 'Promise', 'Set', 'Map', 'WeakSet', 'WeakMap',
    ...
    def _infer_member_expression_type(self, node: Node, content: str, context: Dict[str, Any]) -> str:
    ...
    def _infer_binary_expression_type(self, node: Node, content: str, context: Dict[str, Any]) -> str:
    ...
    def _infer_return_type_from_body(self, body_node: Node, content: str, context: Dict[str, Any]) -> str:
    ...
    def _infer_method_call_type(self, method_node: Node, call_node: Node, content: str, context: Dict[str, Any]) -> str:
    ...
    def _infer_function_return_type(self, func_node: Node, content: str, context: Dict[str, Any]) -> str:
    ...
    def _resolve_generic_property_type(self, generic_type: str, property_name: str) -> str:
        ...
        if base_type in self._type_definitions:
            ...
            if property_sig and type_args:
                ...
                return self._substitute_type_parameters(property_sig, type_def.get('type_parameters', []), type_args)
    ...
    def _substitute_type_parameters(self, signature: str, type_params: List[str], type_args: List[str]) -> str:
    ...
    def parse_type_string(self, type_str: str) -> Dict[str, Any]:
        ...
        if '<' in type_str and '>' in type_str:
            ...
            if type_args_str.strip():
                ...
                type_args = [self.parse_type_string(arg.strip()) for arg in type_args_str.split(',')]
