...
class DeclarationHandler:
    ...
    def _extract_declarations(self, node: Node, content: str, declarations: Dict[str, List], scope_path: List[str]) -> None:
    ...
    def _extract_interface(self, node: Node, content: str, scope_path: List[str]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_type_alias(self, node: Node, content: str, scope_path: List[str]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_function_declaration(self, node: Node, content: str, scope_path: List[str]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_class_declaration(self, node: Node, content: str, scope_path: List[str]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_module_declaration(self, node: Node, content: str, scope_path: List[str]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_enum_declaration(self, node: Node, content: str, scope_path: List[str]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_variable_declaration(self, node: Node, content: str, scope_path: List[str]) -> List[Dict[str, Any]]:
        ...
        for child in node.named_children:
            if child.type == 'variable_declarator':
                ...
                if name_node:
                    ...
                    if type_node:
                        # Skip the ':' token
                        actual_type = type_node.named_children[0] if type_node.named_children else None
                        if actual_type:
    ...
    def _extract_export_declaration(self, node: Node, content: str, scope_path: List[str]) -> Optional[Dict[str, Any]]:
