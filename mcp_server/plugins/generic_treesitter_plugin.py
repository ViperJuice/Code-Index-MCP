...
class GenericTreeSitterPlugin(PluginWithSemanticSearch):
    ...
    def _get_basic_patterns(self) -> List[tuple[str, str]]:
        ...
        pattern_map = {
            'go': [('func ', 'function'), ('type ', 'type'), ('interface ', 'interface')],
            'rust': [('fn ', 'function'), ('struct ', 'struct'), ('enum ', 'enum')],
            'java': [('class ', 'class'), ('interface ', 'interface'), ('public ', 'method')],
            'kotlin': [('fun ', 'function'), ('class ', 'class'), ('interface ', 'interface')],
            'swift': [('func ', 'function'), ('class ', 'class'), ('struct ', 'struct')],
