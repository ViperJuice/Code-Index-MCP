...
class MemoryAwarePluginManager:
    ...
    def __init__(self, 
        ...
        self.high_priority_langs = set(high_priority_langs or ['python', 'javascript', 'typescript'])
    ...
    def _load_plugin(self, language: str) -> Optional[Any]:
        ...
        try:
            ...
            self._weak_refs[language] = weakref.ref(
                plugin, 
                lambda ref, lang=language: self._on_plugin_deleted(lang)
            )
