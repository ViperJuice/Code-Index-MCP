...
SWIFT_CONFIG = {
    ...
    "symbols": [
        ...
        "protocol_declaration", "extension_declaration", "function_declaration",
        "init_declaration", "deinit_declaration", "property_declaration",
        "subscript_declaration", "operator_declaration", "precedence_group_declaration",
        "associated_type_declaration", "import_declaration"
    ],
    "query": """
        ; Classes
...
class SwiftImportResolver(IImportResolver):
    ...
    def _is_system_framework(self, module_name: str) -> bool:
        ...
        system_frameworks = {
            ...
            'CoreGraphics', 'QuartzCore', 'AVFoundation', 'WebKit',
            'MapKit', 'CoreLocation', 'UserNotifications', 'CloudKit'
        }
...
class SwiftBuildSystem(IBuildSystemIntegration):
            ...
            for pattern in package_patterns:
                ...
                for match in matches:
                    ...
                    dependencies.append(BuildDependency(
                        name=name,
                        version=version,
                        registry="swift_package_manager"
                    ))
    ...
    def _parse_targets(self, content: str) -> List[Dict[str, Any]]:
        ...
        for match in matches:
            ...
            targets.append({
                "name": target_name,
                "type": "library"  # Default assumption
            })
...
class SwiftCrossFileAnalyzer(ICrossFileAnalyzer):
    ...
    def _find_symbol_references(self, symbol: str, content: str, file_path: str) -> List[CrossFileReference]:
        ...
        for line_num, line in enumerate(lines, 1):
            ...
            if symbol in line and not line.strip().startswith('//'):
                ...
                references.append(CrossFileReference(
                    symbol=symbol,
