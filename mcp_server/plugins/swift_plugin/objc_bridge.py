...
class ObjectiveCBridge:
    ...
    def find_objc_exposures(self, content: str, file_path: str = "") -> List[ObjCExposure]:
        ...
        for line_num, line in enumerate(lines, 1):
            ...
            objc_match = re.search(r'@objc(?:\(([^)]+)\))?\s+(?:(class|protocol|func|var)\s+(\w+))?', line)
            if objc_match:
    ...
    def _find_foundation_usage(self, content: str, file_path: str) -> List[Dict[str, Any]]:
        ...
        foundation_types = [
            ...
            'NSData', 'NSDate', 'NSURL', 'NSNumber',
            'NSError', 'NSNotification', 'NSUserDefaults'
        ]
        ...
        for foundation_type in foundation_types:
            ...
            for match in matches:
                ...
                is_bridging = ('as ' in context_line or 
                              'bridge' in context_line.lower() or
                              '()' in context_line)  # Initializer call
    ...
    def _find_toll_free_bridging(self, content: str, file_path: str) -> List[Dict[str, Any]]:
        ...
        cf_types = [
            ...
            'CFData', 'CFDate', 'CFURL', 'CFNumber',
            'CFError', 'CFNotification'
        ]
    ...
    def _check_missing_objc_attributes(self, line: str, full_content: str, line_num: int) -> List[Dict[str, Any]]:
        """Check for symbols that should have @objc attributes."""
        issues = []
        
        # Patterns that might need @objc
        if ('IBAction' in line or 'IBOutlet' in line or
            'target:' in line and 'action:' in line):
    ...
    def _check_objc_type_compatibility(self, line: str) -> List[str]:
        ...
        problematic_types = [
            'Set', 'OptionSet', 'Character', 'UInt', 'UInt8', 'UInt16', 'UInt32', 'UInt64',
            'Int8', 'Int16', 'Int32', 'Int64', 'Float80'
        ]
    ...
    def _is_bridging_cast(self, source_type: str, target_type: str) -> bool:
        ...
        return (source_type in self.type_bridges or 
                target_type in self.type_bridges or
                self._is_foundation_bridging(source_type, target_type))
    ...
    def _is_foundation_bridging(self, source_type: str, target_type: str) -> bool:
        ...
        foundation_pairs = [
            ...
            ('Set', 'NSSet'), ('Data', 'NSData'), ('Date', 'NSDate'),
            ('URL', 'NSURL'), ('Int', 'NSNumber'), ('Double', 'NSNumber'),
        ]
    ...
    def _init_type_bridges(self):
        ...
        self.type_bridges = {
            ...
            'Dictionary': TypeBridging('Dictionary', 'NSDictionary', 'automatic', is_collection=True),
    ...
    def _init_objc_frameworks(self) -> Dict[str, List[str]]:
        ...
        return {
            'Foundation': [
                ...
                'NSData', 'NSDate', 'NSURL', 'NSNumber', 'NSError',
                'NSNotification', 'NSUserDefaults', 'NSBundle', 'NSFileManager'
            ],
            'UIKit': [
