...
class JavaTypeAnalyzer(ITypeAnalyzer):
    ...
    def __init__(self, project_root):
        ...
        self.common_types = {
            ...
            'Character', 'Byte', 'Short', 'List', 'Set', 'Map', 'Collection',
            'ArrayList', 'HashSet', 'HashMap', 'LinkedList', 'TreeSet', 'TreeMap'
        }
    ...
    def get_type_info(self, symbol: str, file_path: str) -> Optional[TypeInfo]:
        ...
        if symbol in self.common_types:
            return JavaTypeInfo(
                ...
                generic_params=['T'] if symbol in {'List', 'Set', 'Collection'} else ['K', 'V'] if symbol == 'Map' else []
            )
