...
class PluginFactory:
    ...
    @classmethod
    def create_plugin(cls, language: str, 
        ...
        if language in SPECIFIC_PLUGINS:
            ...
            if callable(plugin_class_or_factory) and not isinstance(plugin_class_or_factory, type):
                ...
                return plugin_class_or_factory(sqlite_store=sqlite_store, enable_semantic=enable_semantic)
            else:
                # It's a class
    ...
    @classmethod
    def create_plugin_for_file(cls, file_path: str | Path,
                              sqlite_store: Optional[SQLiteStore] = None,
                              enable_semantic: bool = True):
    ...
    @classmethod
    def create_all_plugins(cls, sqlite_store: Optional[SQLiteStore] = None,
                          enable_semantic: bool = True) -> Dict[str, object]:
