...
class NLPProcessor:
    ...
    def _determine_text_type(self, text: str, sentences: List[str], 
                           paragraphs: List[Paragraph]) -> TextType:
    ...
    def _is_imperative(self, sentence: str) -> bool:
        ...
        imperative_starts = [
            ...
            'get', 'put', 'keep', 'turn', 'start', 'stop', 'try',
            'use', 'add', 'remove', 'check', 'verify', 'ensure'
        ]
    ...
    def _extract_summary_sentences(self, sentences: List[str], 
                                 topics: List[Topic], max_sentences: int = 5) -> List[str]:
