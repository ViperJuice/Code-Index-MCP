...
class RepositoryPluginLoader:
    ...
    def __init__(self,
        ...
        self.analysis_mode = analysis_mode or os.environ.get('MCP_ANALYSIS_MODE', '').lower() == 'true'
    ...
    async def analyze_repository(self, 
                               ...
                               force_refresh: bool = False) -> RepositoryProfile:
        """
    ...
    async def load_plugins_for_repository(self,
                                        repository_path: Path,
    ...
    def get_priority_languages(self) -> List[str]:
        ...
        priority_order = [
            ...
            'rust', 'c', 'cpp', 'csharp', 'swift', 'kotlin'
        ]
