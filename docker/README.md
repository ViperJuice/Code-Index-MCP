...
docker run -it -v $(pwd):/workspace ghcr.io/consiliency/code-index-mcp:v1.2.0-rc4

# AI-powered search (requires Voyage AI key; lexical search is the image default)
docker run -it -v $(pwd):/workspace -e SEMANTIC_SEARCH_ENABLED=true -e VOYAGE_API_KEY=your-key ghcr.io/consiliency/code-index-mcp:v1.2.0-rc4
