...
Jenkins, GitHub Actions, GitLab CI."""
        ...
        # Index all documents
        docs = ['python_guide.md', 'javascript_tutorial.md', 'ml_basics.md', 
                'data_analysis.md', 'docker_guide.md', 'ci_cd_pipeline.md']
...
Start with [Getting Started](../getting_started.md)."""
        ...
        # Index documents
        for filename in ['main_doc.md', 'getting_started.md', 'advanced.md', 'guides/user_guide.md']:
            self.dispatcher.index_file(self.workspace / filename)
...
Indexing and query optimization."""
        ...
        similar = self.dispatcher.find_similar_documents(
            self.workspace / 'react_tutorial.md',
            threshold=0.5
        )
...
Meeting security standards."""
        ...
        # Index documents
        docs = ['security_overview.md', 'api_security.md', 'performance_guide.md', 'deployment_security.md']
        for filename in docs:
            self.dispatcher.index_file(self.workspace / filename)
        ...
        perf_rank = next((i for i, d in enumerate(security_docs) 
                         if d['document'] == 'performance_guide.md'), -1)
