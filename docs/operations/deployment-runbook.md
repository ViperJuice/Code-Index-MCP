# Deployment Runbook (v1.3.0 stable-surface preparation baseline)

## Overview

This runbook is the operator playbook for the Code-Index-MCP
`v1.3.0` stable-surface preparation baseline. It is not a GA launch document.
...
- Repo-owned package metadata, workflow defaults, installer helpers, and active
  customer docs now point at `v1.3.0`.
