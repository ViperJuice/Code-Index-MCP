...
stable surface `1.3.1`. MCP STDIO is the primary LLM surface, FastAPI is a
...
- **Stable prep**: `v1.3.1` is the prepared, unpublished package and container
