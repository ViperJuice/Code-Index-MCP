...
> **Stable-surface prep status**: This guide targets `1.3.1`. MCP STDIO is the
...
> A July 10, 2026 collision check found no live `index-it-mcp==1.3.1`, so
> this guide keeps public install instructions on source and local-wheel proof
> instead of claiming the prepared `1.3.1` package is published.
