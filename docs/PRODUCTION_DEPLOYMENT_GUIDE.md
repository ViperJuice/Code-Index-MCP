...
VERSION=v1.2.0-rc5 ./scripts/deploy-production.sh
```
...
trivy image ghcr.io/your-org/code-index-mcp:v1.2.0-rc5
...
# 2. Test in staging
VERSION=v1.2.0-rc5 DEPLOYMENT_ENV=staging ./scripts/deploy-production.sh
