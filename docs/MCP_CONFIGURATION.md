...
> **Stable-surface prep status**: This guide targets `1.3.1`. MCP STDIO is the primary
  ...
  "mcpServers": {
    "code-index-minimal": {
      ...
      "args": [
        ...
        "${MCP_DOCKER_IMAGE:-ghcr.io/consiliency/code-index-mcp:v1.3.1}",
        "mcp-index",
        "stdio"
      ]
    }
...
```bash
# Test MCP connection
echo '{"jsonrpc":"2.0","method":"initialize","id":1,"params":{}}' | docker run -i --rm ghcr.io/consiliency/code-index-mcp:v1.3.1
