...
- Run v8 modernization roadmap and prepare v1.3.0 (#69) (Jenner Torrence)
- docs(readme): add plain-English intro, remove internal jargon (#65) (Sthefany-Martins)
- Fix v6 release gate formatting (ViperJuice)
- phase-loop closeout: MRREADY (ViperJuice)
- phase-loop closeout: MRE2E (ViperJuice)
- phase-loop closeout: CIFLOW (ViperJuice)
- phase-loop closeout: WATCH (ViperJuice)
- phase-loop closeout: IDXSAFE (ViperJuice)
- phase-loop closeout: ARTPUB (ViperJuice)
- Retire GARECUT after stable GA dispatch (Jenner Torrence)
- Record GADISP stable release evidence (#60) (Jenner Torrence)
