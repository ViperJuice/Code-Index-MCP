...
# Configuration
REGISTRY=${REGISTRY:-"ghcr.io/consiliency/code-index-mcp"}
TAG=${TAG:-"latest"}
...
usage() {
    ...
    echo ""
    echo "Options:"
    echo "  -r, --registry REGISTRY    Docker registry (default: ghcr.io/consiliency/code-index-mcp)"
    ...
    echo "  $0 --registry ghcr.io/consiliency/code-index-mcp --push"
    echo ""
