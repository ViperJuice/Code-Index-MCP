...
function Select-Variant {
    ...
    Write-Host "1) v1.3.0      - Prepared stable image (recommended)"
    ...
    switch ($choice) {
        ...
        default {
            $script:Variant = "v1.3.0"
            Write-Host "[INFO] Selected: v1.3.0" -ForegroundColor Green
        }
    }
}
...
IF "%MCP_VARIANT%"=="" SET MCP_VARIANT=v1.3.0
