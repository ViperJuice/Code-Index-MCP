...
def test_file_operations():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Update in database
        store.move_file(
            original_info["relative_path"], resolver.normalize_path(new_file), repo_id, content_hash
        )
...
"""
        ...
        dispatcher = EnhancedDispatcher(sqlite_store=store, use_plugin_factory=True, lazy_load=True)
