...
class TestP7SchemaAlignment:
    ...
    def test_repository_present_in_path_accepting_tools(self):
        ...
        path_tools = ["search_code", "symbol_lookup", "reindex", "write_summaries", "summarize_sample"]
        for tool_name in path_tools:
            ...
            assert "properties" in input_schema, f"Tool {tool_name} missing properties in inputSchema"
            assert "repository" in input_schema["properties"], (
    ...
    def test_repository_description_verbatim(self):
        ...
        path_tools = ["search_code", "symbol_lookup", "reindex", "write_summaries", "summarize_sample"]
        for tool_name in path_tools:
            actual_description = self.tools[tool_name].inputSchema["properties"]["repository"]["description"]
    ...
    def test_repository_type_is_string(self):
        ...
        for tool_name in path_tools:
            ...
            assert repo_prop.get("type") == "string", (
    ...
    def test_repository_not_in_required(self):
        ...
        for tool_name in path_tools:
            ...
            assert "repository" not in required, (
