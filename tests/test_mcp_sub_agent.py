...
from mcp_server.utils.sub_agent_helper import SubAgentMCPHelper, SubAgentToolBridge, inherit_mcp_tools
...
class TestIntegration:
        ...
        config = {
            "mcpServers": {
                "code-index-mcp": {
                    ...
                    "args": ["-m", "mcp_server"],
                    "env": {
                        "INDEX_PATH": str(tmp_path / "indexes")
                    }
                }
            }
        }
    ...
    def test_full_propagation_flow(self, full_setup):
        ...
        # Register some tools
        tool_registry.register_tool("symbol_lookup", {
