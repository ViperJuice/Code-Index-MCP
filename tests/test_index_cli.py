...
class TestIntegration:
    ...
    async def test_create_validate_list_flow(self, tmp_path):
        ...
        with patch("asyncio.create_subprocess_exec") as mock_subprocess:
            ...
            result = await create_cmd.execute(
            ...
            with patch("mcp_server.utils.index_discovery.IndexDiscovery.get_local_index_path",
            ...
            with patch.object(list_cmd.path_config, "get_search_paths", 
