...
3. `git switch main`; `git reset --hard worktree-lane-sl-4b-20260419T170149-ms2d` (resolves to the worktree branch's current tip, which carries the full P12–P18 integration history *and* this plan doc at `plans/phase-plan-v1-p19.md`). Log the resolved SHA in the commit message for audit.
